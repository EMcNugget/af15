...
af15 = dict(
    af15desc = "The mission of the 15th Air Force is to provide ready combat forces anytime, anywhere. We aim to be agile, integrated, and lethal Combat Air Forces ready to prevail in conflict. Priorties of the 15th Air Force are split into three main groups people, mission, and culture. Our leaders must be competent, confident and decisive. We will align, certify, and present ready force elements through the Air Force Force Generation Model (AFFORGEN) prepared to compete, deter and prevail in conflict. Airmen are inherently innovative and resourceful.",
)
...
fw1d = dict(
    ...
    opgroup = dict(
        opsg = "The 1st Operations Group directs the training and employment of two F-22 air dominance squadrons and an operations support squadron. The group's flying squadrons maintain the F-22 air superiority fighter aircraft.",
